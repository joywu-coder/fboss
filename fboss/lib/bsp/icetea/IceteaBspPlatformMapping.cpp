...
static BspPlatformMappingThrift buildIceteaPlatformMapping(
...
IceteaBspPlatformMapping::IceteaBspPlatformMapping()
    : BspPlatformMapping(
          buildIceteaPlatformMapping(kJsonBspPlatformMappingStr)) {}

IceteaBspPlatformMapping::IceteaBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(buildIceteaPlatformMapping(platformMappingStr)) {}
